...
export const theme = createTheme({
  ...
  typography: {
    ...
    h4: { fontWeight: 800, letterSpacing: '-.6px', lineHeight: 1.15 },
    h5: { fontWeight: 800, letterSpacing: '-.4px', lineHeight: 1.2 },
    h6: { fontWeight: 800, letterSpacing: '-.2px', lineHeight: 1.25 },
    subtitle1: { fontWeight: 700, letterSpacing: '-.1px' },
    subtitle2: { fontWeight: 700, letterSpacing: '.2px' },
    body1: { lineHeight: 1.55 },
    body2: { lineHeight: 1.5 },
    caption: { letterSpacing: '.1px' },
    button: { textTransform: 'none', fontWeight: 600, letterSpacing: '.1px' },
  },
  components: {
    MuiPaper: {
      styleOverrides: {
    ...
    MuiTooltip: {
      styleOverrides: {
        tooltip: { backgroundColor: '#0f172a', fontSize: 12, fontWeight: 600, borderRadius: 8, padding: '6px 10px' },
        arrow: { color: '#0f172a' },
      },
    },
    MuiMenu: {
      styleOverrides: {
        paper: { borderRadius: 12, border: '1px solid #e7e9ee', boxShadow: '0 12px 32px rgba(15,23,42,.14)' },
      },
    },
    MuiPopover: {
      styleOverrides: { paper: { borderRadius: 12, boxShadow: '0 12px 32px rgba(15,23,42,.14)' } },
    },
    MuiDialog: {
      styleOverrides: { paper: { borderRadius: 16, boxShadow: '0 24px 64px rgba(15,23,42,.24)' } },
    },
